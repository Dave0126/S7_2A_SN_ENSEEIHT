...
public class PhiloSem_Solution1d implements StrategiePhilo {

private Semaphore[] fourchette;

    /****************************************************************/

    public PhiloSem_Solution1d (int nbPhilosophes) {
    ...
    public String nom() {
        return "Implantation Sémaphores, stratégie 'Mettre un ordre sur les ressources, prendre un ordre croissant (Solution 1d)'";
    }
