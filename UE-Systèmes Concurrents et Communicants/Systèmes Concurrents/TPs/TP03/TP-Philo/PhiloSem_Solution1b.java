...
public class PhiloSem_Solution1b implements StrategiePhilo {
...
private Semaphore table;
    ...
    public PhiloSem_Solution1b (int nbPhilosophes) {
    ...
    public String nom() {
        return "Implantation Sémaphores, stratégie 'Limiter le NB de demander a N-1 (Solution 1b)'";
    }
