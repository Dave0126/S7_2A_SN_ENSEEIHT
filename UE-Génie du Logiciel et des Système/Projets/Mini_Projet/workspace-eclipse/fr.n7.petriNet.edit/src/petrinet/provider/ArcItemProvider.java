...
public class ArcItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addPoidPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Poid feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addPoidPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Arc_poid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Arc_poid_feature", "_UI_Arc_type"),
				 PetrinetPackage.Literals.ARC__POID,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Arc arc = (Arc)object;
		return getString("_UI_Arc_type") + " " + arc.getPoid();
	}
