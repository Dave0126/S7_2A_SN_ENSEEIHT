...
public class RessourceItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addNbOccurancePropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Nb Occurance feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addNbOccurancePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ressource_nbOccurance_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ressource_nbOccurance_feature", "_UI_Ressource_type"),
				 SimplepdlPackage.Literals.RESSOURCE__NB_OCCURANCE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Ressource.class)) {
			...
			case SimplepdlPackage.RESSOURCE__NB_OCCURANCE:
