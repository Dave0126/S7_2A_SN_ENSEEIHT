...
public class SimplepdlPackageImpl extends EPackageImpl implements SimplepdlPackage {
	 ...
	 * @generated
	 */
	public EReference getProcess_Ressources() {
	 ...
	 * @generated
	 */
	public EReference getWorkDefinition_Parametres() {
	 ...
	 * @generated
	 */
	public EAttribute getRessource_NbOccurance() {
	 ...
	 * @generated
	 */
	public EAttribute getparametre_Qte() {
	 ...
	 * @generated
	 */
	public EReference getparametre_Ressource() {
	...
	public void createPackageContents() {
		...
		createEReference(processEClass, PROCESS__RESSOURCES);
		...
		createEReference(workDefinitionEClass, WORK_DEFINITION__PARAMETRES);
		...
		createEAttribute(ressourceEClass, RESSOURCE__NB_OCCURANCE);

		parametreEClass = createEClass(PARAMETRE);
		createEAttribute(parametreEClass, PARAMETRE__QTE);
		createEReference(parametreEClass, PARAMETRE__RESSOURCE);
	...
	public void initializePackageContents() {
		...
		initEReference(getProcess_Ressources(), this.getRessource(), null, "ressources", null, 0, -1, simplepdl.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getWorkDefinition_Parametres(), this.getparametre(), null, "parametres", null, 0, -1, WorkDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getRessource_NbOccurance(), ecorePackage.getEInt(), "nbOccurance", null, 0, 1, Ressource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(parametreEClass, parametre.class, "parametre", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getparametre_Qte(), ecorePackage.getEInt(), "Qte", null, 0, 1, parametre.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getparametre_Ressource(), this.getRessource(), null, "ressource", null, 1, 1, parametre.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
