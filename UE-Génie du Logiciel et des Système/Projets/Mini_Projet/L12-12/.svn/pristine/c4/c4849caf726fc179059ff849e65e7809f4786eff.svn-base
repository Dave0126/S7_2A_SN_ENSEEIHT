 ...
 *   <li>{@link simplepdl.impl.WorkDefinitionImpl#getParametres <em>Parametres</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkDefinitionImpl extends ProcessElementImpl implements WorkDefinition {
	...
	public EList<parametre> getParametres() {
		if (parametres == null) {
			parametres = new EObjectContainmentEList<parametre>(parametre.class, this, SimplepdlPackage.WORK_DEFINITION__PARAMETRES);
		}
		return parametres;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__PARAMETRES:
