 ...
 *   <li>{@link simplepdl.impl.ProcessImpl#getRessources <em>Ressources</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProcessImpl extends MinimalEObjectImpl.Container implements simplepdl.Process {
	...
	public EList<Ressource> getRessources() {
		if (ressources == null) {
			ressources = new EObjectContainmentEList<Ressource>(Ressource.class, this, SimplepdlPackage.PROCESS__RESSOURCES);
		}
		return ressources;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case SimplepdlPackage.PROCESS__RESSOURCES:
