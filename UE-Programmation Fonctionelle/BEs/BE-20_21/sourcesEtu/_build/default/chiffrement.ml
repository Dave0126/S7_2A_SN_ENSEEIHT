 ...
 *)
  ...
  (* TODO: let  arbre_to_liste  = fun _ -> assert false *)
 ...
 *)
  ...
  (* TODO: let chiffrer   = fun _ -> assert false *)
 ...
 *)
  ...
  (*  fold :  TO DO
   **)
  (* TODO: let rec fold = fun _ -> assert false *)
   ...
   **)
  (* TODO: let nb_symboles = fun _ -> assert false *)
 ...
 *)
   ...
   **)
  (* TODO: let symboles = fun _ -> assert false *)
 ...
 *)
  ...
  (*  Converti un arbre de chiffrement en une liste associative (symbole de l'alphabet des données, code - liste de symboles de l'alphabet des codes)**)
  (* TODO: let arbre_to_liste_2  = fun _ -> assert false *)
