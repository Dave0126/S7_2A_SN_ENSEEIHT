...
match l with
| [] -> [elt]
| hd::tl -> if ordre elt hd then elt::l 
              else hd::(insert ordre elt tl)
...
let listStat = 
  ...
  let input =  open_in "/home/hurault/Documents/Cours/PFCompil/PF/git/ProgFonctionnelle-SN/TP/TP2/correction/nat2016.txt" in
...
let listStatHomme = 
  ...
  let input =  open_in "/home/hurault/Documents/Cours/PFCompil/PF/git/ProgFonctionnelle-SN/TP/TP2/correction/nathomme2016.txt" in
  let filebuf = Lexing.from_channel input in
  Parser.main Lexer.token filebuf
